...
def json_serializer(obj):
    ...
    raise TypeErorr(f"Object of {obj.__class__.__name__} is not JSON serializable.")

    
def delivery_report(err, msg):
    if err:
        print(f"Messaged delivery failed: {err}")
    else:
        print(f"Messaged delivered to {msg.topic()} [{msg.partition()}]")
